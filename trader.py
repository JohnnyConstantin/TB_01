...
if __name__ == '__main__':
    ...
    parser.add_argument('--coin_amount', type=float, help='Buy/Sell Quantity', default=0)
    ...
    parser.add_argument('--profit', type=float, help='Target Profit', default=0.1)

    parser.add_argument('--stop_loss', type=float, help='Target Stop-Loss %% (If the price drops by 6%%, sell market_price.)', default=0)

    parser.add_argument('--price_increase', type=float, help='Buy Price +Increasing (0.00000001)', default=0.00000001)
    parser.add_argument('--price_decrease', type=float, help='Sell Price -Decreasing (0.00000001)', default=0.00000001)
    ...
    parser.add_argument('--buy_price', type=float, help='Buy Price (Price is greater than equal <=)', default=0)
    parser.add_argument('--sell_price', type=float, help='Sell Price (Price is less than equal >=)', default=0)
    parser.add_argument('--commission', type=str, help='Type of commission, TOKEN/BNB (default BNB)', default='BNB')
